...
class ReportScreenV2 extends StatefulWidget {
  ...
  @override
  _ReportScreenV2State createState() => _ReportScreenV2State();
}

class _ReportScreenV2State extends State<ReportScreenV2> with TickerProviderStateMixin {
        ...
        children: [
          ...
          Expanded(
            child: FlatButton(
                ...
                child: Text(
                  'CONTINUE' /*'$cartButtonText'*/,
                  style: textStyleWhite14px500w,
                ),
                onPressed: () {
                  Navigator.pushNamed(context, Screens.kReportV3Screen);
                }),
          ),
          horizontalSpace(12),
        ],
